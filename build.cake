...
// Define directories.
var buildDir = "./src/SqlTools/bin/" + configuration;
var buildTestDir = "./src/SqlTools.Tests/bin/" + configuration;
...
// Package
var zipPackage = buildResultDir + "/Cake-SqlTools-v" + semVersion + ".zip";
...
{
    // Addin
    CopyFileToDirectory(buildDir + "/Cake.SqlTools.dll", binDir);
    CopyFileToDirectory(buildDir + "/Cake.SqlTools.pdb", binDir);
    ...
    // Test
    CreateDirectory("./test/tools/Addins/Cake.SqlTools/lib/net45/");

    CopyFileToDirectory(buildDir + "/Cake.SqlTools.dll", "./test/tools/Addins/Cake.SqlTools/lib/net45/");
});
...
Task("Create-NuGet-Packages")
    ...
    .Does(() =>
{
    NuGetPack("./nuspec/Cake.SqlTools.nuspec", new NuGetPackSettings
    {
        Version = version,
    ...
    .Does(() =>
{
    ...
    // Push the package.
    var package = nugetRoot + "/Cake.SqlTools." + version + ".nupkg";
